...
void cashier(){
    ...
    do {
        ...
        cout << left << setw(5) << quantity << setw(15) << isbn << setw(25) << title << setw(2) << "$" << setw(8) << fixed << setprecision(2) << price << setw(2) << "$" << setw(8) << showpoint << fixed << setprecision(2) << total << endl << endl;
